...
//input arr of ints
//return # of nums that are not in correct place (0 if sorted arr is same as input arr)
//Input: heights = [1,1,4,2,1,3] -> Output: 3
//Input: heights = [1,2,3,4,5] -> Output: 0
//store sorted arr ascending in new variable
//compare int in each arr at same position
//if different, add one to count
//return count